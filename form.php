...
if ($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    if(empty(trim($_POST['firstname']) )){
        ...
        $errName ="Only letters and whote space allowed";
        };
    }
    ...
    if(empty(trim($_POST['gender']) )){
        $errGender = "- Gender is not selected -";
    }
    if(isset($_POST['submit'])){
        ...
        $errFirstname ="Only letters and whote space allowed";
        }
        else{
        // error
        $error = true;
...
<div class="container">
    ...
    <form  method="post" action="index.php">
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="inputfirstname" name="firstname" placeholder="Firstname" value=
                <?php echo $firstname ?>>
        ...
        <div class="form-group row">
        <label for="Subject" class="col-sm-2 col-form-label">Your country</label>
            <div class="col-sm-4">
            ...
            <label for="Subject" class="col-sm-2 col-form-label">Your subject</label>
            <div class="col-sm-4">
                <form action="#" method="post">
                    <select id="subject" name="subject">
                        <option value="contact">Contactsssssssss</option>
        ...
        <div class="form-group row">
                <label for="inputUser" class="col-sm-2 col-form-label">Comments</label>
                <div class="col-sm-10">
                <textarea cols="100" rows="4" name="comments" id="inputcomments" placeholder="Comments">
                <?php echo $errComments;?></textarea>
                </div>
                <div class="col-6"></div>  
